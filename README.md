...
In this lab, you will apply Security Engineering principles - open design, least privilege, **complete mediation** (every access to every resource must be checked for authorization - every time (<a href="https://doi.org/10.1109/PROC.1975.9939" target="_blank" rel="noopener noreferrer">Saltzer & Schroeder, 1975</a>), and defense in depth - to the software supply chain. Modern systems depend on many third-party components. Knowing what’s inside a system is essential to designing, verifying, and maintaining secure software. An SBOM provides this transparency by listing every package, library, and dependency that makes up an application or container. You will use GitHub Codespaces and open-source tools to generate, analyze, and compare SBOMs for the NG911 software repository, then reflect on how this information supports secure design and lifecycle assurance.
